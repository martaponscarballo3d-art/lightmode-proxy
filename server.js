...
The reference image is only a soft structural guide. Client requested changes are mandatory.
`;

      const negativePromptFinal = negativePrompt ||
        "blurry, low quality, distorted, deformed, ugly, watermark, logo, person, hand, finger, face, skin, cropped jewelry, partial view, cut off, duplicate jewelry, broken chain, melted metal, warped geometry, impossible structure, random letters, misspelled name, unreadable nameplate, cheap plastic, toy jewelry, cartoon, illustration, fantasy";
      ...
      form.append('image_strength', String(strength || 0.18));
